...
export const LAYER_PROPS_TOGGLE = 'LAYER_PROPS_TOGGLE';
export const LAYER_PARENT_CHANGE = 'LAYER_PARENT_CHANGE';
export const LAYER_NAME_CHANGE = 'LAYER_NAME_CHANGE';
export const SET_CURRENT_LAYER_ID = 'SET_CURRENT_LAYER_ID';
export const ORIGIN_VALUE_CHANGE = 'ORIGIN_VALUE_CHANGE';
